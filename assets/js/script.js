...
function handleSubmit(event) {
  ...
  const activistyLevel = getSelectedValue('activity_level');
  ...
  const maintenance = Math.round(tmb * Number(activistyLevel));
  ...
  <div class="result-content">
    <ul>
      ...
      <li>
        Para ganhar peso você precisa consumir em média <strong>${gaiWeight} calorias</strong>.
      </li>
    </ul>
  </div>
  `;
